...
insert into backgrounds (name, description, choices)
  ...
  You know what people want and you deliver, or rather, you promise to deliver.  Common sense should steer people away from things that sound too good to be true, but common sense seems to be in short supply when you''re around.  The bottle of pink-colored liquid will surely cure that unseemly rash, this ointment -- nothing more that a bit of fat with as sprinke of silver dust -- can restore youth and vigor, and there''s a bridge in the city that just happens to be for sale.  These marvels sound implausible, but you make them sound like the real deal.', 'Favorite Schemes|Every charlatan has an angle he or she uses in preference to other schemes.  Choose a favorite scheme or roll on the table below.');

insert into backgrounds (name, description, choices)
  values('Criminal', 'You are and experienced criminal with a history of breaking the law.  You have spent a lot of time among other criminals and still have contacts within the criminal underworld.  You''re far close than most people to the world of murder, theft, and violence that pervades the underbelly of civilization, and you have survived up to this point by flouting the rules and regulations of society.', 'Criminal Speciality|There are many kinds of criminals, and within a thieves'' guild or similar criminal organization, individual members have particular specialities.  Even criminals who operate outside of such organizations have strong preferences for certain kinds of crimes over others.  Choose a role you plalyed in your criminal life, or roll on the table below.');
...
insert into backgrounds (name, description, choices)
  values('Folk Hero', 'You come from a humble social rank, but you are destined for so much more.  Already the people of you home village regard you as their champion, and your destiny calls you to stand against the tyrants and monsters that threaten the common folk everywhere.', 'Defining Event|You previously pursued a simple profession among the peasantry, perhaps as a farmer, miner, servant, shepherd, woodcutter, or gravedigger.  But something happened to set you on a different path and marked you for greater things.  Choose or randomly determine a defining event that marked you as a hero of the people.');

insert into backgrounds (name, description, choices)
  values('Guild Artisan', 'You are a member of an atrisan''s guild, skilled in a particular field and closely associate with other artisans.  You are a well-established part of the mercantile world, freed by talent and wealth from the constraints of a feudal social order.  You learned your skills as an apprentice to a master artisan, under the sponsorship of your guild, until you became a master in your own right.', 'Guild Business|Guilds are generally found in cities large enough to support several artisans practicing the same trade.  However, your guild might instead be a loose network of artisans who each work in a different village within a larger realm.  Work with your DM to determine the nature of your guild.  You can select you guild business from ghe Guild Business table or roll randomly.');

insert into backgrounds (name, description, choices)
  values('Hermit', 'You lived in seclusion -- either in a sheltered community such as a monastery, or entirely alone -- for a formative part of your life.  In your time apart from the clamor of society, you found quiet, solitude, and perhaps som of the answers you were looking for.', 'Life of Seclusion|What was the reason for your isolation, and what changed to allow you to end your solitude?  You can work with your DM to determine the exact nature of your seclusion, or you can choose or roll on the table below to determine the reason behind your seclusion.');
